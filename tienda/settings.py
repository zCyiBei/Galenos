...
# Configuración del archivo estático
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Ruta donde se guardarán los archivos estáticos recolectados
STATIC_URL = '/static/'  # URL que usará Django para acceder a los archivos estáticos
